      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 24px", display: "flex", alignItems: "center", justifyContent: "space-between", height: 64 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 12, cursor: "pointer" }} onClick={() => { setPage("home"); window.scrollTo(0, 0); }}>
          ...
          <div>
            ...
            <div style={{ color: '#475569', fontSize: 10, letterSpacing: 1.5, textTransform: "uppercase" }}>Formation IA · Abidjan</div>
          </div>
        </div>
    ...
    <div style={{ display: "flex", gap: 16, justifyContent: "center", flexWrap: "wrap" }}>
      {units.map((u) => (
        <div key={u.label} style={{ background: "rgba(0,0,0,0.08)", border: "1px solid rgba(0,0,0,0.12)", borderRadius: 12, padding: "16px 20px", minWidth: 80, textAlign: "center", backdropFilter: "blur(10px)" }}>
          ...
          <div style={{ fontSize: 11, color: '#475569', textTransform: "uppercase", letterSpacing: 2, marginTop: 4 }}>{u.label}</div>
        </div>
      ))}
    </div>
  );
  ...
  return (
    <section style={{
      ...
      <div style={{ maxWidth: 800, textAlign: "center", position: "relative", zIndex: 1 }}>
        ...
        <p style={{ fontSize: 18, color: '#475569', lineHeight: 1.7, margin: "0 0 12px", maxWidth: 700, marginLeft: "auto", marginRight: "auto" }}>
        ...
        <p style={{ fontSize: 14, color: '#475569', margin: "0 0 40px" }}>
          Organisé par <strong style={{ color: '#475569' }}>RMK Conseils</strong> · Formation délivrée par <strong style={{ color: "#C9A84C" }}>CABEXIA</strong>
        </p>
        ...
        <CountdownBlock />
        <p style={{ color: '#475569', fontSize: 12, marginTop: 12, letterSpacing: 1 }}>AVANT LE PREMIER SÉMINAIRE</p>
      </div>
        ...
        {SEMINARS.map((s) => (
          <div key={s.id} style={{
            ...
            <div>
              ...
              <div style={{ color: '#475569', fontSize: 11 }}>{s.week}</div>
            </div>
          </div>
        ))}
      </div>
    ...
    <section ref={ref} style={{ background: "#FAF9F6", padding: "80px 24px", borderTop: "1px solid rgba(0,0,0,0.05)" }}>
      <div style={{ maxWidth: 900, margin: "0 auto", opacity: vis ? 1 : 0, transform: vis ? "none" : "translateY(30px)", transition: "all 0.8s ease" }}>
        <div style={{ textAlign: "center", marginBottom: 48 }}>
          ...
          <p style={{ color: '#475569', fontSize: 16, marginTop: 12 }}>Le meilleur du présentiel et du distanciel, combinés pour un impact maximal.</p>
        </div>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(340px, 1fr))", gap: 24 }}>
          {steps.map((s, i) => (
            <div key={i} style={{ background: "rgba(0,0,0,0.03)", borderRadius: 16, padding: 32, border: "1px solid rgba(0,0,0,0.08)" }}>
              ...
              <p style={{ color: '#475569', lineHeight: 1.7, margin: 0, fontSize: 15 }}>{s.desc}</p>
            </div>
          ))}
        </div>
    ...
    <div ref={ref} style={{
      ...
      <div style={{ padding: "24px 28px" }}>
        ...
        {expanded && (
          <div style={{ marginBottom: 16, animation: "fadeIn 0.3s ease" }}>
            ...
            {sem.highlights.map((h: string, i: number) => (
              <div key={i} style={{ fontSize: 13, color: '#475569', padding: "4px 0 4px 16px", position: "relative" }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginTop: 8, paddingTop: 16, borderTop: "1px solid rgba(0,0,0,0.05)" }}>
          <div>
            <div style={{ fontSize: 24, fontWeight: 800, color: "#1B2A4A" }}>{fmt(PRICE)} <span style={{ fontSize: 13, fontWeight: 400, color: '#475569' }}>FCFA</span></div>
    ...
    <section style={{ background: "#FAF9F6", minHeight: "100vh", paddingTop: 100, paddingBottom: 80 }}>
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: "0 24px" }}>
        <div style={{ textAlign: "center", marginBottom: 48 }}>
          ...
          <p style={{ color: '#475569', fontSize: 16 }}>Chaque séminaire : 3 jours présentiel à Abidjan + 2 sessions en ligne de 4h · Formation délivrée par CABEXIA</p>
        </div>
    ...
    <section style={{ background: "linear-gradient(170deg, #FAF9F6, #E0DCCD)", minHeight: "100vh", paddingTop: 100, paddingBottom: 80 }}>
      <div ref={ref} style={{ maxWidth: 1100, margin: "0 auto", padding: "0 24px", opacity: vis ? 1 : 0, transform: vis ? "none" : "translateY(30px)", transition: "all 0.8s" }}>
        <div style={{ textAlign: "center", marginBottom: 48 }}>
          ...
          <p style={{ color: '#475569', fontSize: 16 }}>Tarif identique pour les 4 séminaires · Formation complète 5 jours hybride</p>
        </div>
  ...
  if (submitted) return (
    <section style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: "#FAF9F6", paddingTop: 80 }}>
      <div style={{ textAlign: "center", maxWidth: 500, padding: 40 }}>
        ...
        <p style={{ color: '#475569', fontSize: 16, lineHeight: 1.7 }}>Merci {form.prenom}. L'équipe RMK vous contactera sous 24h pour confirmer votre inscription et les modalités de paiement.</p>
    ...
    <section style={{ minHeight: "100vh", background: "#FAF9F6", paddingTop: 100, paddingBottom: 80 }}>
      <div style={{ maxWidth: 640, margin: "0 auto", padding: "0 24px" }}>
        <div style={{ textAlign: "center", marginBottom: 40 }}>
          ...
          <p style={{ color: '#475569', fontSize: 15 }}>Sélection exclusive par séminaire · Inscription confirmée après validation du paiement</p>
        </div>
        <div style={{ background: "rgba(0,0,0,0.03)", borderRadius: 20, padding: 36, border: "1px solid rgba(0,0,0,0.08)" }}>
          ...
          <div style={{ marginTop: 20, padding: 16, background: "rgba(201,168,76,0.1)", borderRadius: 10, border: "1px solid rgba(201,168,76,0.3)" }}>
            ...
            <div style={{ fontSize: 12, color: '#475569', marginTop: 4 }}>Payez {fmt(prices?.earlyBird || EARLY_BIRD_PRICE)} FCFA au lieu de {fmt(prices?.standard || PRICE)} FCFA · Économisez {fmt((prices?.standard || PRICE) - (prices?.earlyBird || EARLY_BIRD_PRICE))} FCFA</div>
          </div>
          ...
          <p style={{ textAlign: "center", fontSize: 12, color: '#475569', marginTop: 12 }}>En soumettant ce formulaire, vous serez contacté par l'équipe RMK pour finaliser votre inscription.</p>
        </div>
      </div>
    </section>
  );
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: 32, marginBottom: 32 }}>
          <div>
            ...
            <p style={{ color: '#475569', fontSize: 13, lineHeight: 1.7 }}>Organisé par RMK à Abidjan. Formations délivrées par CABEXIA, Cabinet d'Expertise en Intelligence Artificielle.</p>
          </div>
          <div>
            <div style={{ color: '#475569', fontSize: 12, fontWeight: 700, letterSpacing: 1, marginBottom: 12, textTransform: "uppercase" }}>Navigation</div>
            {["home", "seminaires", "tarifs", "inscription"].map((p) => (
              <div key={p} style={{ marginBottom: 8 }}>
                <button onClick={() => { setPage(p); window.scrollTo(0, 0); }} style={{ background: "none", border: "none", color: '#475569', cursor: "pointer", fontSize: 14, padding: 0 }}>
                  {p === "home" ? "Accueil" : p.charAt(0).toUpperCase() + p.slice(1)}
                </button>
              </div>
            ))}
            <div style={{ marginBottom: 8 }}>
                <button onClick={() => navigate('/portal')} style={{ background: "none", border: "none", color: '#475569', cursor: "pointer", fontSize: 14, padding: 0 }}>
                  Portail Client
                </button>
            </div>
            <div style={{ marginBottom: 8 }}>
                <button onClick={() => navigate('/admin')} style={{ background: "none", border: "none", color: '#475569', cursor: "pointer", fontSize: 14, padding: 0 }}>
                  Admin
                </button>
            </div>
          </div>
          <div>
            <div style={{ color: '#475569', fontSize: 12, fontWeight: 700, letterSpacing: 1, marginBottom: 12, textTransform: "uppercase" }}>Contact</div>
        ...
        <div style={{ borderTop: "1px solid rgba(0,0,0,0.06)", paddingTop: 16, display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 8 }}>
          <div style={{ color: '#475569', fontSize: 12 }}>© 2026 RMK × CABEXIA · Tous droits réservés</div>
          <div style={{ color: '#475569', fontSize: 12 }}>Formation délivrée par CABEXIA – Cabinet d'Expertise en Intelligence Artificielle</div>
        </div>
      </div>
    </footer>
  );
