export const COMMERCIAL_STRATEGY = `CABEXIA
...
4.1 LinkedIn (canal principal) : Organique (3-4 posts/semaine) + Ads (Budget 200 000 FCFA)
4.2 Emailing B2B (3 séquences) : Annonce, Valeur ajoutée, Urgence.
4.3 Ordres professionnels & associations : Partenariats stratégiques (Ordre des Notaires, OECCA-CI, CGECI, APBEF-CI, ANDRH-CI).
4.4 WhatsApp Business : Canal dominant en Côte d'Ivoire.
4.5 Webinaire teaser gratuit : 45 minutes de démonstration.

5. Répartition des Rôles
CABEXIA (Expertise IA) : Conception pédagogique, Animation, Création supports, Démonstrations.
RMK Conseils (Organisation) : Gestion inscriptions, Logistique, Marketing, Relances, Gestion financière.

6. Budget Marketing Global
LinkedIn Ads : 200 000 FCFA
Supports visuels : 50 000 FCFA
Emailing : 50 000 FCFA
Webinaire teaser : 30 000 FCFA
Partenariats : 100 000 FCFA
Divers : 70 000 FCFA
TOTAL : 500 000 FCFA`;
