...
insert into public.venues (
  ...
  ('v6','Hôtel Tiama','Rue du Général de Gaulle, Plateau','Plateau',4,150,60,200000,380000,1550000,'Bamba Mariam','+225 27 22 21 78 00','commercial@tiama-hotel.ci',ARRAY['wifi','projecteur','catering']::text[],'Hôtel boutique, ambiance feutrée pour ateliers exclusifs'),
